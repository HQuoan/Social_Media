...
export const toast = (function (bootstrap) {
  'use strict';
  ...
  function Toast(props) {
    ...
    this.containerId =
      'bootstrap-show-toast-container-' + this.props.position.replace(' ', '_');
    ...
    if (showHeader) {
      toastHeader = `<div class="toast-header text-bg-danger">
