...
},{}],"templateURL.js":[function(require,module,exports) {
"use strict";
...
module.exports = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(method, url, to, data, message) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (message !== '') (0, _alerts.showAlert)('success', message);
          if (!(to !== '')) {
            _context.next = 10;
            break;
          }
...
},{"axios":"../../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"socket.js":[function(require,module,exports) {
"use strict";
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var friends = {};
var viewOnlineUsers = function viewOnlineUsers(users) {
  var wrapOnlineUser = document.getElementById('list-online');
  var html = '';
...
var getFriends = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "/api/v1/friendships/friends";
          _context.next = 3;
          return (0, _templateURL.default)('GET', url, '', {}, '');
        case 3:
        ...
        case 6:
          ...
          socket.on('getOnlineUsers', function (onlineUsers) {
            ...
            friends.forEach(function (friend) {
              var isOnline = onlineUsers.some(function (user) {
          ...
          socket.on('getMessage', function (data) {
            var audio = new Audio('../audio/ting-ting.mp3');
          ...
          if (wrapper) {
            wrapper.addEventListener('click', function (e) {
              ...
              if (target.closest('.sendMessage')) {
                var x = target.closest('.sendMessage');
...
var appendMessageReceiver = function appendMessageReceiver(user, text) {
  ...
  var html = "\n  <div class=\"chat chat-left\">\n        <div class=\"chat-user\">\n          <a class=\"avatar m-0\">\n            <img src=\"../img/users/".concat(user.avatar, "\" alt=\"avatar\" class=\"avatar-35\">\n          </a>\n          <span class=\"chat-time mt-1\">").concat(moment(Date.now()).format('LT'), "</span>\n        </div>\n        <div class=\"chat-detail\">\n          <div class=\"chat-message\">\n            <p>").concat(text, "</p>\n          </div>\n        </div>\n      </div>\n  ");
  chatBox.insertAdjacentHTML('beforeend', html);
};
var appendMessageSender = function appendMessageSender(userAvatar, text) {
  var chatBox = document.getElementById('chat-box');
  var html = "\n  <div class=\"chat d-flex other-user\">\n  <div class=\"chat-user\">\n    <a class=\"avatar m-0\">\n      <img src=\"../img/users/".concat(userAvatar, "\" alt=\"avatar\" class=\"avatar-35\">\n    </a>\n    <span class=\"chat-time mt-1\">").concat(moment(Date.now()).format('LT'), "</span>\n  </div>\n  <div class=\"chat-detail\">\n    <div class=\"chat-message\">\n      <p>").concat(text, "</p>\n    </div>\n  </div>\n</div>\n  ");
  chatBox.insertAdjacentHTML('beforeend', html);
};
},{"./templateURL.js":"templateURL.js"}],"login.js":[function(require,module,exports) {
"use strict";
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          (0, _templateURL.default)('POST', '/api/v1/users/login', '/', data, 'Logged in successfully!');
        case 1:
        case "end":
          return _context.stop();
      }
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _templateURL.default)('POST', '/api/v1/users/signup', '/', data, 'Sign up successfully!');
        case 2:
        case "end":
          return _context2.stop();
      }
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _templateURL.default)('POST', '/api/v1/users/forgotPassword', '/reset-password', data, 'Successfully!');
        case 2:
        case "end":
          return _context3.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          (0, _templateURL.default)('POST', url, '/', data, 'Successfully!');
        case 3:
        case "end":
  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          data = {};
          (0, _templateURL.default)('GET', '/api/v1/users/logout', '/', data, ':Logout successfully!');
        case 2:
        case "end":
...
},{"./templateURL.js":"templateURL.js"}],"user.js":[function(require,module,exports) {
"use strict";
...
},{"./templateURL.js":"templateURL.js"}],"postItem.js":[function(require,module,exports) {
"use strict";
...
exports.loadPostScroll = exports.loadPost = exports.deletePost = exports.createPost = void 0;
var _templateURL = _interopRequireDefault(require("./templateURL.js"));
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
...
var createPost = exports.createPost = function createPost(data) {
  (0, _templateURL.default)('POST', '/api/v1/posts/me', '/profile', data, 'Successfully!');
};
...
var getAllPosts = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/posts/?limit=2&page=".concat(page)
          });
        case 3:
  ...
  return function getAllPosts(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var getMyPosts = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/posts/me?limit=2&page=".concat(page)
          });
        case 3:
  ...
  return function getMyPosts(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
var appendPosts = function appendPosts(div, posts) {
  var html = '';
  posts.forEach(function (post) {
    html += (0, _postItem.postItem)(post);
  });
  div.innerHTML += html;
};
var loadPost = exports.loadPost = function loadPost(div, btn) {
  var page = 2;
...
var loadPostScroll = exports.loadPostScroll = function loadPostScroll(div) {
  var loadGif = document.getElementById('load-gif');
  var page = 2;
  var loading = false;
  var disable = false;
  window.addEventListener('scroll', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var y, divHeight, posts;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          y = window.scrollY;
        ...
        case 12:
          ...
          console.error('Error loading posts:', _context5.t0);
        case 15:
          _context5.prev = 15;
          loading = false;
...
},{"./templateURL.js":"templateURL.js","axios":"../../../node_modules/axios/index.js","./alerts.js":"alerts.js","./postItem.js":"postItem.js"}],"friendShip.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateFriendShip = exports.deleteRequest = exports.createRequest = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _templateURL = _interopRequireDefault(require("./templateURL.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var createRequest = exports.createRequest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(receiver) {
    var data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          (0, _templateURL.default)('POST', '/api/v1/friendships/me', '', data, 'Successfully!');
        case 2:
        case "end":
          return _context.stop();
      }
...
var updateFriendShip = exports.updateFriendShip = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id, status) {
    var url, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          url = "api/v1/friendships/me/".concat(id);
          data = {
            status: status
          };
          (0, _templateURL.default)('PATCH', url, '', data, 'Accepted!');
        case 3:
        case "end":
          return _context2.stop();
      }
  ...
  return function updateFriendShip(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
var deleteRequest = exports.deleteRequest = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          url = "api/v1/friendships/me/".concat(id);
          (0, _templateURL.default)('DELETE', url, '', data, 'Deleted!');
        case 3:
        case "end":
          return _context3.stop();
      }
  ...
  return function deleteRequest(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
},{"axios":"../../../node_modules/axios/index.js","./alerts.js":"alerts.js","./templateURL.js":"templateURL.js"}],"emoji.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var createEmoji = exports.createEmoji = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var url, message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "/api/v1/emojis/me";
          message = '';
          if (data.type === 'null') {
          ...
          _context.next = 5;
          return (0, _templateURL.default)('POST', url, '', data, message);
        case 5:
        case "end":
          return _context.stop();
      }
  ...
  return function createEmoji(_x) {
    return _ref.apply(this, arguments);
  };
}();
},{"./templateURL.js":"templateURL.js"}],"room.js":[function(require,module,exports) {
"use strict";
...
var appendRooms = function appendRooms(div, rooms) {
  ...
  rooms.forEach(function (room) {
    if (room.members.length === 2) {
      var x = room.members[0].id === userId ? room.members[1] : room.members[0];
      html += roomItem(room.id, x);
    }
  });
  div.innerHTML = html;
};
var appendMessages = function appendMessages(div, room) {
  var userId = document.getElementById('user_id').dataset.userId;
  var x = {};
  if (room.members.length === 2) {
...
var getMyRooms = exports.getMyRooms = /*#__PURE__*/function () {
  ...
  return function getMyRooms(_x) {
    return _ref.apply(this, arguments);
  };
}();
var getRoomWithChat = exports.getRoomWithChat = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(divRoom) {
    var roomId, url, room, divChat;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          roomId = divRoom.dataset.roomId; // console.log(roomId);
          url = "/api/v1/rooms/me/".concat(roomId);
          _context2.next = 4;
          return (0, _templateURL.default)('GET', url, '', {}, '');
        case 4:
          room = _context2.sent;
...
/* eslint-disable */
var commentItem = exports.commentItem = function commentItem(comment) {
  var ms = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var replySection = comment.reply ? "\n      <a class=\"btn-reply collapsed\" href=\"#_".concat(comment.id, "\" data-bs-toggle=\"collapse\" aria-expanded=\"false\" aria-controls=\"").concat(comment.id, "\" data-comment-id=\"").concat(comment.id, "\">\n        <i class=\"fas fa-reply fa-rotate-180\"></i>\n        <span class=\"ms-1\">").concat(comment.reply, " Replies</span>\n      </a>\n      <br>\n      <ul class=\"reply-comment iq-menu p-0 collapse\" id=\"_").concat(comment.id, "\" style=\"list-style-type: none;\"></ul>\n    ") : '';
  return "\n  <ul class=\"post-comments p-0\" class=\"ms-".concat(ms, "\">\n  <li class=\"mb-2 d-flex justify-content-between\">\n    <div class=\"d-flex flex-wrap\">\n      <div class=\"user-img\">\n        <a href=\"/").concat(comment.user.key, "\">\n          <img class=\"avatar-35 rounded-circle img-fluid\" src=\"../img/users/").concat(comment.user.avatar, "\" alt=\"userimg\">\n        </a>\n      </div>\n      <div class=\"comment-data-block ms-3 wrap-comment\">\n        <a href=\"/").concat(comment.user.key, "\">\n           <h6>").concat(comment.user.username, "</h6>\n        </a>\n        <p class=\"comment-content mb-0\">").concat(comment.comment, "</p>\n        <div class=\"block-add-form-create-comment\">\n          <div class=\"d-flex flex-wrap align-items-center comment-activity\">\n            <a href=\"#\">like</a>\n            <a class=\"btn-add-form-reply\" href=\"#\" data-parent-comment-id=\"").concat(comment.id, "\" data-post-id=\"").concat(comment.post, "\">reply</a>\n            <span>").concat(comment.moment, "</span>\n          </div>\n          <div class=\"feather-icon comment-box\">\n            ").concat(replySection, "\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"card-post-toolbar\">\n      <div class=\"dropdown\">\n        <span class=\"dropdown-toggle\" data-bs-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\" role=\"button\">\n          <i class=\"ri-more-fill vertical-icon\"></i>\n        </span>\n        <div class=\"dropdown-menu m-0 p-0\">\n          <a class=\"btnUpdateComment dropdown-item p-3\" href=\"#\" data-comment-id=\"").concat(comment.id, "\">\n            <div class=\"d-flex align-items-top\">\n              <i class=\"ri-pencil-line h4\"></i>\n              <div class=\"data ms-2\">\n                <p>Edit Comment</p>\n              </div>\n            </div>\n          </a>\n          <a class=\"btnDelComment dropdown-item p-3\" href=\"#\" data-comment-id=\"").concat(comment.id, "\">\n            <div class=\"d-flex align-items-top\">\n              <i class=\"ri-delete-bin-7-line h4\"></i>\n              <div class=\"data ms-2\">\n                <p>Delete</p>\n              </div>\n            </div>\n          </a>\n        </div>\n      </div>\n    </div>\n  </li>\n</ul>\n\n  ");
};
...
exports.updateComment = exports.loadComments = exports.getReplyComments = exports.deleteComment = exports.createComment = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _templateURL = _interopRequireDefault(require("./templateURL.js"));
...
var appendReplyComments = function appendReplyComments(div, comments) {
  ...
  comments.forEach(function (comment) {
    html += (0, _commentItem.commentItem)(comment, 3);
  });
...
var createComment = exports.createComment = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_form, data) {
    var url, comment, comments, wrap, commentBox;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          url = "/api/v1/comments/me";
          _context3.next = 3;
          return (0, _templateURL.default)('POST', url, '', data, 'Created Comment');
        case 3:
        ...
        case 6:
          ...
          wrap = _form.closest('.wrap-comment');
          commentBox = wrap.querySelector('.comment-box');
...
var getReplyComments = exports.getReplyComments = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(btnReply) {
    var commentId, url, response, wrap, box;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          commentId = btnReply.dataset.commentId;
          url = "api/v1/comments/".concat(commentId, "/reply");
          _context4.prev = 2;
          _context4.next = 5;
          return (0, _axios.default)({
            method: 'GET',
        ...
        case 5:
          ...
          wrap = btnReply.closest('.post-comments');
          box = wrap.querySelector('.reply-comment');
...
var updateComment = exports.updateComment = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data, commentId) {
    var url, response;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          url = "api/v1/comments/me/".concat(commentId);
          _context5.prev = 1;
          _context5.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 4:
          ...
          if (response.data.status === 'success') {
            (0, _alerts.showAlert)('success', ' Update comment successfully');
          }
...
var deleteComment = exports.deleteComment = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(commentId) {
    var url, response;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 4:
          ...
          if (response.status === 204) {
            (0, _alerts.showAlert)('success', ' Delete comment successfully');
          }
...
},{"axios":"../../../node_modules/axios/index.js","./alerts.js":"alerts.js","./templateURL.js":"templateURL.js","./commentItem.js":"commentItem.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _friendShip = require("./friendShip.js");
...
var postDataForm = document.querySelector('.form-post');

// socket
(0, _socket.createSocket)(io);

// sử dụng cho các form KHÔNG có ảnh
var getFormData = function getFormData(form) {
  var btnSubmit = form.querySelector('.btnSubmit');
  if (btnSubmit) btnSubmit.innerHTML = "<i class=\"fas fa-sync-alt fa-spin\"></i> Waiting";
  var formData = {};
...
if (postDataForm) {
  postDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var btnSubmit = postDataForm.querySelector('.btnSubmit');
    btnSubmit.innerHTML = "<i class=\"fas fa-sync-alt fa-spin\"></i> Waiting";
    var formData = new FormData(postDataForm);
    (0, _post.createPost)(formData);
  });
}
if (userDataForm) {
  userDataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var btnSubmit, formData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            btnSubmit = userDataForm.querySelector('.btnSubmit');
            btnSubmit.innerHTML = "<i class=\"fas fa-sync-alt fa-spin\"></i> Waiting";
            formData = new FormData(userDataForm);
            _context.next = 6;
            return (0, _user.updateUser)(formData, 'data');
          case 6:
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            _context2.next = 3;
            return (0, _user.updateUser)(getFormData(userPasswordForm), 'password');
          case 3:
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            _context3.next = 3;
            return (0, _login.login)(getFormData(loginForm));
          case 3:
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            _context4.next = 3;
            return (0, _login.signup)(getFormData(signUpForm));
          case 3:
...
if (forgotForm) {
  forgotForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            e.preventDefault();
            _context5.next = 3;
            return (0, _login.forgot)(getFormData(forgotForm));
          case 3:
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            e.preventDefault();
            _context6.next = 3;
            return (0, _login.reset)(getFormData(resetForm));
          case 3:
...
// Load more posts
var wrapProfilePosts = document.getElementById('wrap-profile-posts');
var wrapPosts = document.getElementById('wrap-posts');
var loadPostBtn = document.getElementById('load-more-post');
if (wrapProfilePosts && loadPostBtn) {
  (0, _post.loadPost)(wrapProfilePosts, loadPostBtn);
}
if (wrapPosts) {
  (0, _post.loadPostScroll)(wrapPosts);
}

/// Friend
var btnAddFriends = document.querySelectorAll('.btnAddFriend');
if (btnAddFriends) {
  btnAddFriends.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      var receiver = el.dataset.receiverId;
      (0, _friendShip.createRequest)(receiver);
      el.innerText = 'Requested';
    });
  });
}
var btnAcceptFriends = document.querySelectorAll('.accept-friend');
if (btnAcceptFriends) {
  btnAcceptFriends.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
...
var btnDeleteRequests = document.querySelectorAll('.delete-request');
if (btnDeleteRequests) {
  btnDeleteRequests.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      var reqId = el.dataset.requestId;
...
var btnUnfriends = document.querySelectorAll('.unfriend');
if (btnUnfriends) {
  btnUnfriends.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      ...
      (0, _friendShip.deleteRequest)(sender, data);
...
divContainer.addEventListener('click', function (event) {
  ...
  if (target.closest('.room-item')) {
    ...
    (0, _room.getRoomWithChat)(roomItem);
  }

  // emoji
  if (target.classList.contains('emoji-item')) {
    event.preventDefault();
    var likeData = target.closest('.like-data');
    if (likeData) {
      var emojiActive = likeData.querySelector('.emoji-active-item');
      emojiActive.src = target.src;
      var post = emojiActive.dataset.postId;
      var type = target.dataset.emoji;
      var data = {
        post: post,
        type: type
      };
      (0, _emoji.createEmoji)(data);
    }
  }

  // create comment
  var btnSubmitComment = target.closest('.btnSubmitComment');
  if (btnSubmitComment) {
    event.preventDefault();
    var form = target.closest('.comment-form');
    (0, _comment.createComment)(form, getFormData(form));
  }
  ...
  if (parent.classList.contains('btn-reply')) {
    if (!isFirstClickMap.has(parent)) {
      ...
      (0, _comment.getReplyComments)(parent);
  ...
  // btnUpdateComment
  var btnUpdateComment = target.closest('.btnUpdateComment');
  if (btnUpdateComment) {
    event.preventDefault();
    var divComment = btnUpdateComment.closest('.post-comments');
    var commentId = btnUpdateComment.dataset.commentId;
    addFormUpdateComment(divComment, commentId);
  }

  // btnDelComment
  var btnDelComment = target.closest('.btnDelComment');
  if (btnDelComment) {
    event.preventDefault();
    var _divComment = btnDelComment.closest('.post-comments');
    var _commentId = btnDelComment.dataset.commentId;
    deleteCommentFunc(_divComment, _commentId);
  }

  // delete post
  var btnDelPosts = document.querySelectorAll('.btnDelPost');
  if (btnDelPosts.length > 0) {
    btnDelPosts.forEach(function (btnDelPost) {
      btnDelPost.addEventListener('click', function () {
        var postId = btnDelPost.dataset.postId;
        (0, _post.deletePost)(postId);
      });
    });
  }
});
var addFormCreateComment = function addFormCreateComment(block, postId, parentCommentId) {
  var formHTML = "\n      <form class=\"reply-comment-form comment-text d-flex align-items-center mt-3\">\n          <textarea class=\"comment-txt form-control rounded-pill\" name=\"comment\" rows=\"1\" placeholder=\"\"></textarea>\n          <input type=\"hidden\" name=\"post\" value=\"".concat(postId, "\">\n          <input type=\"hidden\" name=\"parentComment\" value=\"").concat(parentCommentId, "\">\n          <div class=\"comment-attachment d-flex\">\n              <button type=\"submit\" class=\"btn hover-blue\"><i class=\"fa fa-paper-plane\"></i></button>\n              <button class=\"btn btnCancel hover-red\"><i class=\"fas fa-times\">Cancel</i></button>\n          </div>\n      </form>\n  ");
  ...
  var btnCancel = lastForm.querySelector('.btnCancel');
  if (btnCancel) {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.next = 6;
            return (0, _comment.updateComment)(formData, commentId);
          case 6:
            res = _context8.sent;
            if (res === 'success') {
...
var deleteCommentFunc = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(divComment, commentId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.next = 2;
          return (0, _comment.deleteComment)(commentId);
        case 2:
          res = _context9.sent;
          if (res.status === 204) {
            divComment.remove();
  ...
  return function deleteCommentFunc(_x9, _x10) {
