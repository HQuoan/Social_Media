...
var template = /*#__PURE__*/function () {
  ...
  return function template(_x, _x2, _x3, _x4, _x5) {
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          template('POST', '/api/v1/users/forgotPassword', '/reset-password', data, 'Successfully!');
        case 1:
        case "end":
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.login)(getFormData(loginForm));
  });
}
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.signup)(getFormData(signUpForm));
  });
}
if (forgotForm) {
  forgotForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.forgot)(getFormData(forgotForm));
  });
}
if (resetForm) {
  resetForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.reset)(getFormData(resetForm));
  });
}
