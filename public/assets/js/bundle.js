...
},{"./templateURL.js":"templateURL.js","axios":"../../../node_modules/axios/index.js","./alerts.js":"alerts.js","./postItem.js":"postItem.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var btnDelPost = document.querySelector('.btnDelPost');
// sử dụng cho các form CÓ ảnh
var getFormData2 = function getFormData2(form) {
...
if (postDataForm) {
  postDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _post.createPost)(getFormData2(postDataForm));
  });
}
if (userDataForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            e.preventDefault();
            _context.next = 4;
            return (0, _user.updateUser)(getFormData2(userDataForm), 'data');
          case 4:
