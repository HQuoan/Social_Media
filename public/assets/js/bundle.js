...
exports.updateFriendShip = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var updateFriendShip = exports.updateFriendShip = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          response = _context.sent;
          if (response.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Accepted');
          }
          _context.next = 11;
          break;
        case 7:
  ...
  return function updateFriendShip(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"emoji.js":[function(require,module,exports) {
"use strict";
